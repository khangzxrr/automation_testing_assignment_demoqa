...
public class ElementLocators
{
    public class TC01_VerifyStudentRegistration
    {
        ...
        public static By DOB_Day_21_XPath1 = By.XPath(
            "//div[@id='dateOfBirth']//div[@class='react-datepicker__day react-datepicker__day--021']"
        );
        ...
        public static By Subjects_CSS2 = By.CssSelector(
            ".subjects-auto-complete__indicator-separator"
        );
        ...
        public static By City_Selectable_XPath1(string city) =>
            By.XPath(
                $"//div[@id='city']//div[text() = '{city}' and contains(@id, 'react-select-4')]"
            );
    ...
    public class TC03_VerifyEmailValidation
    {
        ...
        public static By EmailError_XPath1 = By.XPath(
            "//input[@id='userEmail' and @type='email' and not(@value)]"
        );
        public static By EmailError_XPath2 = By.XPath(
            "//input[contains(@class, 'form-control') and @type='email' and not(@value)]"
        );
    }
    ...
    public class TC09_VerifyBookStoreSearchAndCollection
    {
        ...
        public static By BookTitles_CSS1 = By.CssSelector(
            ".rt-tbody .rt-tr-group .rt-td:nth-child(2) a"
        );
        public static By BookTitles_CSS2 = By.CssSelector(
            "div.rt-tbody div.rt-tr-group div.rt-td:nth-child(2) a"
        );
        public static By BookTitles_XPath1 = By.XPath(
            "//div[@class='rt-tbody']//div[@class='rt-tr-group']//a"
        );
        ...
        public static By AddToCollectionButton_XPath1 = By.XPath(
            "//button[@id='addNewRecordButton']"
        );
        public static By AddToCollectionButton_XPath2 = By.XPath(
        ...
        public static By DeleteAllBooksButton_XPath2 = By.XPath(
            "//button[text()='Delete All Books']"
        );
    ...
    public class TC10_VerifySliderFunctionality
    {
        ...
        public static By SliderInput_XPath1 = By.XPath(
        ...
        public static By SliderValue_XPath2 = By.XPath(
            "//div[@id='sliderContainer']//div[@class='col-3']/input"
        );
    ...
    public class TC11_VerifyProgressBarOperations
    {
        ...
        public static By ProgressValue_XPath2 = By.XPath(
            "//div[contains(@class, 'progress-bar') and contains(text(), '%')]"
        );
    ...
    public class TC13_VerifyModalDialogs
    {
        ...
        public static By ModalTitle_XPath1 = By.XPath(
        ...
        public static By SmallModal_Close_XPath1 = By.XPath(
            "//div[@id='example-modal-sizes-title-sm']/following-sibling::button[contains(@class,'close')]"
        );
    ...
    public class TC14_VerifyAccordionSections
    {
        ...
        public static By Section2Heading_XPath2 = By.XPath(
            "//div[text()='Where does it come from?']"
        );
        ...
        public static By Section3Collapse_XPath1 = By.XPath(
            "//div[@id='section3Content']/parent::div"
        );
    ...
    public class TC15_VerifyAutoCompleteFunctionality
    {
        ...
        public static By MultipleColorInput_CSS2 = By.CssSelector(
            "input#autoCompleteMultipleInput"
        );
        public static By MultipleColorInput_XPath1 = By.XPath(
            "//input[@id='autoCompleteMultipleInput']"
        );
        public static By MultipleColorInput_XPath2 = By.XPath(
            "//div[@id='autoCompleteMultipleContainer']//input"
        );

        // Multiple Color Selected Values
        public static By MultipleColorSelected_CSS1 = By.CssSelector(
            ".auto-complete__multi-value__label"
        );
        public static By MultipleColorSelected_CSS2 = By.CssSelector(
            "div.auto-complete__multi-value__label"
        );
        public static By MultipleColorSelected_XPath1 = By.XPath(
            "//div[contains(@class, 'auto-complete__multi-value__label')]"
        );
        public static By MultipleColorSelected_XPath2 = By.XPath(
            "//div[@id='autoCompleteMultipleContainer']//div[contains(@class, 'auto-complete__multi-value__label')]"
        );
        ...
        public static By SingleColorInput_XPath1 = By.XPath(
            "//input[@id='autoCompleteSingleInput']"
        );
        public static By SingleColorInput_XPath2 = By.XPath(
            "//div[@id='autoCompleteSingleContainer']//input"
        );

        public static By SingleColorValue_XPath1 = By.XPath(
            "//div[contains(@class,'auto-complete__single-value')]"
        );

        // Single Color Selected Value
        public static By SingleColorSelected_CSS1 = By.CssSelector(".auto-complete__single-value");
        public static By SingleColorSelected_CSS2 = By.CssSelector(
            "div.auto-complete__single-value"
        );
        public static By SingleColorSelected_XPath1 = By.XPath(
            "//div[contains(@class, 'auto-complete__single-value')]"
        );
        public static By SingleColorSelected_XPath2 = By.XPath(
            "//div[@id='autoCompleteSingleContainer']//div[contains(@class, 'auto-complete__single-value')]"
        );
        ...
        public static By AutoCompleteOptions_XPath1 = By.XPath(
            "//div[contains(@class, 'auto-complete__option')]"
        );
        public static By AutoCompleteOptions_XPath2 = By.XPath(
            "//div[@class='auto-complete__menu']//div[contains(@class, 'auto-complete__option')]"
        );
